...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.products.index')->with('status', 'produto adicionado com successo');
    }
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('admin.products.index')->with('status', 'produto "'.$title.'" deletado com sucesso');
    }
}
